...
{
    public class Data : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = Infraestrutura. Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Infraestrutura.Properties.Resources.calendarDark;
                else calendarIcon = Infraestrutura.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
